...
QT_MOC_LITERAL(1, 12, 13), // "filterChanged"
QT_MOC_LITERAL(2, 26, 0), // ""
QT_MOC_LITERAL(3, 27, 10), // "checkGroup"
QT_MOC_LITERAL(4, 38, 1), // "c"
QT_MOC_LITERAL(5, 40, 12) // "uncheckGroup"

    },
    "EventFilter\0filterChanged\0\0checkGroup\0"
    "c\0uncheckGroup"
};
...
void EventFilter::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->checkGroup((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 2: _t->uncheckGroup((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&EventFilter::filterChanged)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void EventFilter::filterChanged()
{
