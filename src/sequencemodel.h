...
public:
    ...
    const drumstick::SequencerEvent* getEvent(const int row) const;
    void clear();
    void saveToTextStream(QTextStream& str);
    void saveToFile(const QString& path);
    void loadFromFile(const QString& path);
    void appendEvent(long ticks, double seconds, int track, drumstick::SequencerEvent* ev);

    void appendSMFEvent(long ticks, int track, drumstick::SequencerEvent* ev);
    void appendWRKEvent(long ticks, int track, drumstick::SequencerEvent* ev);
    void appendOVEEvent(long ticks, int track, drumstick::SequencerEvent* ev);
...
private:
    ...
    QString event_source(const drumstick::SequencerEvent *ev) const;
    QString event_ticks(const drumstick::SequencerEvent *ev) const;
    QString event_client(const drumstick::SequencerEvent *ev) const;
    QString event_addr(const drumstick::SequencerEvent *ev) const;
    QString event_sender(const drumstick::SequencerEvent *ev) const;
    QString event_dest(const drumstick::SequencerEvent *ev) const;
    QString common_param(const drumstick::SequencerEvent *ev) const;
    QString event_kind(const drumstick::SequencerEvent *ev) const;
    QString event_channel(const drumstick::SequencerEvent *ev) const;
    QString event_data1(const drumstick::SequencerEvent *ev) const;
    QString event_data2(const drumstick::SequencerEvent *ev) const;
    QString event_data3(const drumstick::SequencerEvent *ev) const;
    QString note_name(const int note) const;
    QString note_key(const drumstick::SequencerEvent* ev) const;
    QString note_velocity(const drumstick::SequencerEvent* ev) const;
    QString note_duration(const drumstick::SequencerEvent* ev) const;
    QString control_param(const drumstick::SequencerEvent* ev) const;
    QString control_value(const drumstick::SequencerEvent* ev) const;
    QString program_number(const drumstick::SequencerEvent* ev) const;
    QString pitchbend_value(const drumstick::SequencerEvent* ev) const;
    QString chanpress_value(const drumstick::SequencerEvent* ev) const;
    QString sysex_type(const drumstick::SequencerEvent *ev) const;
    QString sysex_chan(const drumstick::SequencerEvent *ev) const;
    QString sysex_data1(const drumstick::SequencerEvent *ev) const;
    QString sysex_data2(const drumstick::SequencerEvent *ev) const;
    QString sysex_data3(const drumstick::SequencerEvent *ev) const;
    int sysex_data_first(const drumstick::SequencerEvent *ev) const;
    QString sysex_mtc(const int id) const;
    QString sysex_mmc(const int id) const;
    QString tempo_bpm(const drumstick::SequencerEvent *ev) const;
    QString tempo_npt(const drumstick::SequencerEvent *ev) const;
    QString text_type(const drumstick::SequencerEvent *ev) const;
    QString text_data(const drumstick::SequencerEvent *ev) const;
    QString time_sig1(const drumstick::SequencerEvent *ev) const;
    QString time_sig2(const drumstick::SequencerEvent *ev) const;
    QString key_sig1(const drumstick::SequencerEvent *ev) const;
    QString key_sig2(const drumstick::SequencerEvent *ev) const;
    QString smpte(const drumstick::SequencerEvent *ev) const;
    QString var_event(const drumstick::SequencerEvent *ev) const;
    QString meta_misc(const drumstick::SequencerEvent *ev) const;
    void processItems();
    ...
    Song m_items;
    Song m_tempSong;
    drumstick::QSmf* m_smf;
    drumstick::QWrk* m_wrk;
    drumstick::QOve* m_ove;
    Instrument* m_ins;
    Instrument* m_ins2;
    ...
    typedef void (SequenceModel::*AppendFunc)(long,int,drumstick::SequencerEvent*);
